    ...
    <div class="sales-board-form">
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          ...
          <v-counter :max="20" :min="5" @on-counter="couResult"></v-counter>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
        ...
        <div class="sales-board-line-right">
          ...
          <v-multi-choose :multiChoosers="versionList" @on-multichoose="multiChoResult"></v-multi-choose>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
